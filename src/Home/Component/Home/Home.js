                            ...
                            <div className='col-lg-12  col-sm-10 justify-content-center  align-center p-3'> 
                                ...
                                <div className="col-lg-8 col-sm-6 justify-content-center p-2">
                                       <div className="card-body justify-content-between">
                                         <h3 className="row card-title justify-content-center text-dark">Humraahi ?</h3>
                                         <p className="row card-text p-1  justify-content-center">Humrahi ,literal meaning ,
                                          is the person who stays by your side for your life .<b>Humraahi</b> is also a Friend for IITG people ,making the travling from campus to city and nearby towns easier and fun .Humraahi is Cab Shaaring website Based on the previous requests we will find You a Match who can travel with you.You can chat with the person before you travel With them and enjoy the trip to city. </p>
                                 <div className="row  justify-content-center">
                ...
                <div className="container-fluid">
                        <div className="row p-3 mb-2 justify-content-center align-center">
                            ...
                            <div className='col-lg-12  col-sm-10 justify-content-center bg-white align-center p-3'> 
                                ...
                                <animated.p className="row card-text p-1  justify-content-center" style={action}>
